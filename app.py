...
from views.subscriptionRoutes import subscription_bp
from views.subscriptionHistoryRoutes import subscription_history_bp
from views import accountRoutes
from views import userRoutes
from views import bookRoutes
from views import genreRoutes
from views import subscriptionRoutes
from views import subscriptionHistoryRoutes
...
subscriptionRoutes.init_app(app)
subscriptionHistoryRoutes.init_app(app)
